...
import { useReducedMotion, useScroll, useTransform, motion, useInView } from 'motion/react';

const EASE_OUT$2 = [0.18, 0.78, 0.2, 1];
const HERO_RIBBON = "M -40 1040 C 360 1080, 640 760, 780 540 C 880 400, 550 400, 600 400 C 220 400, 220 660, 540 720 C 880 780, 1240 620, 1400 520 C 1560 400, 1900 380, 3500 480";
function BoardHero() {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsx(
                motion.p,
                {
                  ...
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.9, ease: EASE_OUT$2, delay: 0.8 },
              ...
              /* @__PURE__ */ jsxs(
                "h1",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "block", children: ["Meet", "the"].map((word, i) => /* @__PURE__ */ jsx(
                      "span",
                      {
                    ...
                    /* @__PURE__ */ jsx("span", { className: "block", children: /* @__PURE__ */ jsx("span", { className: "inline-block overflow-hidden align-top", children: /* @__PURE__ */ jsx(
                      motion.span,
                      {
                        className: "inline-block",
                        initial: { y: prefersReduced ? 0 : "110%" },
                        animate: { y: 0 },
                        transition: prefersReduced ? { duration: 0 } : { duration: 1.2, ease: EASE_OUT$2, delay: 0.54 },
                        children: "Team."
                      }
                    ) }) })
                  ]
              ...
              /* @__PURE__ */ jsxs(
                motion.p,
                {
                  ...
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.9, ease: EASE_OUT$2, delay: 0.82 },
                  children: [
                    "The students who keep ASU running by planning every GBM, fundraiser, and social you'll see this year.",
                    /* @__PURE__ */ jsx("span", { className: "block w-14 h-px bg-asu-gold mt-[22px]" })
                  ]
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            initial: { opacity: 0 },
            animate: { opacity: 0.7 },
            transition: prefersReduced ? { duration: 0 } : { duration: 1, delay: 1.2 },
            "aria-hidden": "true",
            children: [
              /* @__PURE__ */ jsx("span", { className: "font-ui text-[11px] tracking-[0.3em] uppercase text-asu-cream block mb-2", children: "Scroll" }),
              /* @__PURE__ */ jsx(
                motion.svg,
                {
                  width: "14",
...
const EASE_OUT$1 = [0.18, 0.7, 0.2, 1];
function BoardIntro() {
  const prefersReduced = useReducedMotion();
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(
                    motion.path,
                    {
                      ...
                      transition: prefersReduced ? { duration: 0 } : { duration: 2.4, ease: [0.4, 0, 0.2, 1] }
                    }
                  )
                ]
              }
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 pt-10", children: [
          /* @__PURE__ */ jsxs(
            motion.p,
            {
              ...
              transition: prefersReduced ? { duration: 0 } : { duration: 0.9, ease: EASE_OUT$1 },
              children: [
          ...
          /* @__PURE__ */ jsxs(
            motion.h2,
            {
              ...
              initial: { opacity: 0, y: 36 },
              animate: isInView ? { opacity: 1, y: 0 } : {},
              transition: prefersReduced ? { duration: 0 } : { duration: 0.9, ease: EASE_OUT$1, delay: 0.12 },
              children: [
          ...
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              initial: { opacity: 0, y: 36 },
              animate: isInView ? { opacity: 1, y: 0 } : {},
              transition: prefersReduced ? { duration: 0 } : { duration: 0.9, ease: EASE_OUT$1, delay: 0.42 },
              children: [
                /* @__PURE__ */ jsx(
                  "span",
                  {
...
const EASE_OUT = [0.18, 0.78, 0.2, 1];
const OFFICERS = [
  {
    id: "danton",
    role: "President",
  ...
  },
  {
    ...
    year: "Sophmore",
    blurb: "Hi everyone! my name is Olivia, feel free to call me by whatever! I am going to be ASU's fundraising chair for this year so here's some of my interests! I love to dance and bake, reading the tri-man (manga, manhwa, and manhua) as well as webtoons like Eleceed, Omniscient Reader's Viewpoint, and Heaven's Official Blessing. Live, love, laugh Haikyuu and I love desserts so let me know if any of ya'll want to hit up a fire dessert place 😛"
  },
  {
    id: "yukari",
      ...
      children: [
        /* @__PURE__ */ jsx(
          "span",
          {
            ...
            style: {
              background: "linear-gradient(90deg, transparent, #EFE1C8 30%, #EFE1C8 70%, transparent)"
            }
          }
        ),
        /* @__PURE__ */ jsxs("span", { className: "font-ui text-[12px] tracking-[0.32em] uppercase text-asu-red px-1.5 whitespace-nowrap", children: [
          /* @__PURE__ */ jsx(
            "span",
            {
...
function OfficerCard({
  ...
  return /* @__PURE__ */ jsx(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-8 lg:gap-20 items-center h-full", children: [
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  animate: isInView ? { x: 0, rotate: flagRestRotate, opacity: 0.92 } : { x: flagStartX, rotate: flagFlyRotate, opacity: 0 },
                  transition: prefersReduced ? { duration: 0 } : {
                    x: {
                      duration: 1.5,
              ...
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  animate: isInView ? { width: "100%", opacity: 0.9 } : { width: 0, opacity: 0 },
                  transition: prefersReduced ? { duration: 0 } : {
                    width: {
                      duration: 1.2,
                      ease: [0.2, 0.7, 0.2, 1],
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(
                    motion.div,
                    {
                      ...
                      style: {
                        background: "radial-gradient(ellipse at center, rgba(26,20,16,0.28) 0%, rgba(26,20,16,0.10) 45%, transparent 75%)"
                      },
                      initial: { scaleX: 0.4, opacity: 0 },
                      animate: isInView ? { scaleX: 1, opacity: 1 } : { scaleX: 0.4, opacity: 0 },
                      transition: prefersReduced ? { duration: 0 } : {
                        scaleX: {
                          duration: 1.1,
                          ease: [0.2, 0.7, 0.2, 1],
                    ...
                    motion.div,
                    {
                      ...
                      children: imgError ? /* @__PURE__ */ jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsx("span", { className: "font-ui text-[11px] tracking-[0.2em] uppercase text-asu-muted mb-8 opacity-50 select-none", children: "Photo coming soon" })
                        }
                      ) : /* @__PURE__ */ jsx(
                        "img",
                        {
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: `relative z-[2] py-3 px-0 md:px-3 ${isEven ? "lg:order-1" : "lg:order-2"}`,
            children: [
              /* @__PURE__ */ jsxs(
                motion.div,
                {
                  ...
                  animate: isInView ? { opacity: 1, y: 0 } : {},
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.7, ease: EASE_OUT, delay: 0.35 },
                  children: [
                    /* @__PURE__ */ jsx("span", { className: "w-9 h-px bg-asu-red inline-block flex-shrink-0" }),
                    officer.role
                  ]
                }
              ),
              /* @__PURE__ */ jsx(
                motion.h3,
                {
                  ...
                  initial: { opacity: 0, y: 28 },
                  animate: isInView ? { opacity: 1, y: 0 } : {},
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.7, ease: EASE_OUT, delay: 0.46 },
              ...
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  initial: { opacity: 0, y: 28 },
                  animate: isInView ? { opacity: 1, y: 0 } : {},
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.7, ease: EASE_OUT, delay: 0.58 },
                  children: [
                    { label: "Major", value: officer.major },
                    { label: "Hometown", value: officer.hometown },
                    { label: "Year", value: officer.year }
                  ].map(({ label, value }) => /* @__PURE__ */ jsxs("dl", { className: "m-0 flex flex-col gap-0.5", children: [
                    /* @__PURE__ */ jsx("dt", { className: "font-ui text-[11px] tracking-[0.22em] uppercase text-asu-muted", children: label }),
                    /* @__PURE__ */ jsx("dd", { className: "m-0 font-body text-[15px] text-asu-dark font-medium", children: value })
                  ] }, label))
                }
              ),
              /* @__PURE__ */ jsx(
                motion.div,
                {
                  ...
                  initial: { opacity: 0, y: 28 },
                  animate: isInView ? { opacity: 1, y: 0 } : {},
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.7, ease: EASE_OUT, delay: 0.66 }
                }
              ),
              /* @__PURE__ */ jsxs(
                motion.p,
                {
                  ...
                  initial: { opacity: 0, y: 28 },
                  animate: isInView ? { opacity: 1, y: 0 } : {},
                  transition: prefersReduced ? { duration: 0 } : { duration: 0.7, ease: EASE_OUT, delay: 0.74 },
                  children: [
                    /* @__PURE__ */ jsx(
                      "span",
                      {
...
function OfficerRoster() {
  ...
  return /* @__PURE__ */ jsxs("section", { ref: rosterRef, className: "relative z-[1] bg-asu-ivory", children: [
    /* @__PURE__ */ jsx(
      "nav",
      {
        ...
        children: OFFICERS.map((officer, i) => /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: i === activeIndex && /* @__PURE__ */ jsx("span", { className: "absolute right-[18px] top-1/2 -translate-y-1/2 font-ui text-[10px] tracking-[0.22em] uppercase text-asu-dark bg-asu-ivory px-[10px] py-1 border border-asu-beige rounded-[2px] whitespace-nowrap pointer-events-none", children: officer.role })
          },
          officer.id
        ))
      }
    ),
    /* @__PURE__ */ jsx("div", { className: "max-w-[1440px] mx-auto px-8 md:px-14 lg:px-24 pt-16 pb-40", children: ROSTER_ITEMS.map((item) => {
      if (item.type === "divider") {
        return /* @__PURE__ */ jsx(SectionDivider, { label: item.label }, item.label);
      }
      if (item.type === "sep") {
        return /* @__PURE__ */ jsx(OfficerSeparator, {}, item.key);
      }
      return /* @__PURE__ */ jsx(
        OfficerCard,
        {
...
const $$Board = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Meet the Team — Asian Student Union @ Iowa State University", "description": "The students who keep ASU running by planning every GBM, fundraiser, and social you'll see this year." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="relative overflow-x-hidden">  ${renderComponent($$result2, "BoardHero", BoardHero, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Bench/ASUWebsite/src/components/board/BoardHero", "client:component-export": "BoardHero" })}  ${renderComponent($$result2, "BoardIntro", BoardIntro, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Bench/ASUWebsite/src/components/board/BoardIntro", "client:component-export": "BoardIntro" })}  ${renderComponent($$result2, "OfficerRoster", OfficerRoster, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "C:/Bench/ASUWebsite/src/components/board/OfficerRoster", "client:component-export": "OfficerRoster" })}  <section class="relative z-[1] bg-asu-espresso text-asu-cream text-center overflow-hidden" style="padding: 200px 56px 140px;">  <svg class="absolute top-[-2px] left-0 right-0 w-full pointer-events-none" style="height: 160px;" viewBox="0 0 1920 160" preserveAspectRatio="none" aria-hidden="true"> <path d="M 0 0 L 1920 0 L 1920 70 C 1480 130, 1080 40, 700 90 C 360 130, 120 70, 0 100 Z" fill="#FFF9ED"></path> </svg> <div class="relative z-10 max-w-3xl mx-auto"> <p class="font-ui text-[12px] tracking-[0.25em] uppercase text-asu-gold mb-5">
Want to join the board?
</p> <h3 class="font-display text-asu-cream leading-[1.08] mb-6 mx-auto" style="font-size: clamp(2.5rem, 5vw, 4rem); max-width: 760px;">
Applications open every spring.
</h3> <p class="font-body font-light text-base leading-[1.7] text-asu-cream max-w-[520px] mx-auto mb-9" style="opacity: 0.78;">
Interested in helping run ASU next year? Watch our socials and the
          newsletter for when officer applications open.
</p> <a href="/connect/socials" class="inline-flex items-center gap-2.5 px-[30px] py-[14px] bg-asu-red text-asu-cream font-ui font-medium text-[14px] tracking-[0.08em] rounded transition-colors hover:bg-asu-red-hover">
Get notified →
</a> </div> </section> </main> ` })}`;
}, "C:/Bench/ASUWebsite/src/pages/board.astro", void 0);

const $$file = "C:/Bench/ASUWebsite/src/pages/board.astro";
const $$url = "/board";
