...
function SocialCard({
  ...
  return /* @__PURE__ */ jsx(
    motion.div,
    {
      ...
      transition: prefersReduced ? { duration: 0 } : { duration: 1.1, ease: EASE_OUT, delay: 0.85 + index * 0.18 },
      style: {
        perspective: 1100,
        flex: 1,
        display: "flex",
      ...
      children: /* @__PURE__ */ jsxs(
        ...
        {
          ref,
          style: prefersReduced ? { flex: 1, display: "flex", flexDirection: "column" } : {
            flex: 1,
            display: "flex",
            flexDirection: "column",
            rotateX: srx,
          ...
          children: [
            /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                animate: {
                  boxShadow: isHovered && !prefersReduced ? "0 0 0 1.5px rgba(229,41,30,0.6), 0 24px 64px rgba(229,41,30,0.14), 0 8px 28px rgba(30,28,18,0.18)" : "0 0 0 1px rgba(232,198,106,0.18), 0 6px 24px rgba(30,28,18,0.1)"
                },
            ...
            /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col h-full p-9 gap-6", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-5 h-px bg-asu-gold opacity-60" }),
                      /* @__PURE__ */ jsx("p", { className: "font-ui text-[11px] font-bold tracking-[0.26em] uppercase text-asu-gold opacity-90", children: isIG ? "Instagram" : "TikTok" })
                    ] }),
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative", style: { zIndex: 2 }, children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center px-8 pt-16 pb-10", children: [
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                animate: { opacity: 1, y: 0 },
                transition: prefersReduced ? { duration: 0 } : { duration: 0.7, ease: EASE_OUT, delay: 0.15 },
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-6 h-px bg-asu-red opacity-60" }),
                  /* @__PURE__ */ jsx("p", { className: "font-ui text-[12px] font-bold tracking-[0.28em] uppercase text-asu-red", children: "Asian Student Union · Connect" }),
                  /* @__PURE__ */ jsx("div", { className: "w-6 h-px bg-asu-red opacity-60" })
                ]
              }
            ),
            /* @__PURE__ */ jsx("div", { className: "mb-7", children: ["Follow", "Our Story."].map((word, i) => /* @__PURE__ */ jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsx(
              motion.p,
              {
                ...
                animate: { opacity: 1, y: 0 },
                transition: prefersReduced ? { duration: 0 } : { duration: 0.8, ease: EASE_OUT, delay: 0.62 },
            ...
            /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                animate: { scaleX: 1 },
                transition: prefersReduced ? { duration: 0 } : { duration: 0.5, ease: EASE_OUT, delay: 0.72 }
              }
            ) })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "px-10 pb-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto flex flex-col md:flex-row md:items-stretch gap-8", children: [
            /* @__PURE__ */ jsx(
              SocialCard,
              {
                platform: "instagram",
...
const $$Socials = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Socials — Asian Student Union @ Iowa State University", "description": "Follow ASU on Instagram and TikTok to stay connected with events, updates, and club life." }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="flex-1"> ${renderComponent($$result2, "SocialsHero", SocialsHero, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Bench/ASUWebsite/src/components/socials/SocialsHero", "client:component-export": "SocialsHero" })} </main> ` })}`;
}, "C:/Bench/ASUWebsite/src/pages/connect/socials.astro", void 0);

const $$file = "C:/Bench/ASUWebsite/src/pages/connect/socials.astro";
const $$url = "/connect/socials";
