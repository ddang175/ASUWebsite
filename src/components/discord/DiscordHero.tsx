...
// Same throw-onto-a-table easing used by the home polaroids
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Asian Student Union · Discord
        </motion.p>

        {/* ── Discord logo — large gold icon, polaroid fly-in ────────── */}
        <motion.div
          className="mb-7"
          initial={
            prefersReduced
              ? { opacity: 0 }
              : { x: 520, y: -340, rotate: 28, scale: 1.12, opacity: 0 }
          }
          animate={
            prefersReduced
              ? { opacity: 1 }
        ...
        >
          <DiscordLogo className="w-32 h-32 text-asu-gold" />
        </motion.div>
        ...
        >
          {[["Join", "the"], ["Community."]].map((line, li) => (
        ...
        >
          Participate in online-only events, chat with members and the board,
          play games, get live updates, and be involved with the community!
        </motion.p>
